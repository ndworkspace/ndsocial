...
public class FileSortHelper {
    ...
    private abstract class FileComparator implements Comparator<FileInfoBase> {

        @Override
        public int compare(FileInfoBase object1, FileInfoBase object2) {
        ...
        protected abstract int doCompare(FileInfoBase object1, FileInfoBase object2);
    }

    private Comparator cmpName = new FileComparator() {
        @Override
        public int doCompare(FileInfoBase object1, FileInfoBase object2) {
    ...
    private Comparator cmpType = new FileComparator() {
        @Override
        public int doCompare(FileInfoBase object1, FileInfoBase object2) {
            int result = FilePathHelper.getExtFromFilename(object1.fileName).compareToIgnoreCase(
                    FilePathHelper.getExtFromFilename(object2.fileName));
            if (result != 0)
                return result;

            return FilePathHelper.getNameFromFilename(object1.fileName).compareToIgnoreCase(
                    FilePathHelper.getNameFromFilename(object2.fileName));
        }
    };
}
