...
public class DecodeServiceBase implements DecodeService
{
    ...
    public static final String DECODE_SERVICE = "DecodeService";
    ...
    public void decodePage(Object decodeKey, int pageNum, final LoadPageCallback decodeCallback, float zoom, RectF pageSliceBounds)
    {
    ...
    {
        currentDecodeTask.decodeCallback.onLoadComplete(currentDecodeTask.decodeKey, currentDecodeTask.pageNumber, bitmap);
    }
    ...
    private class DecodeTask
    {
        ...
        private final LoadPageCallback decodeCallback;
        private final RectF pageSliceBounds;

        private DecodeTask(int pageNumber, LoadPageCallback decodeCallback, float zoom, Object decodeKey, RectF pageSliceBounds)
        {
