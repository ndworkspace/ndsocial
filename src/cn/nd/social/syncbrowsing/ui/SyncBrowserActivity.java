...
public class SyncBrowserActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		PrivateSwitcher.showPrivateDialog(this,KEY_HIDE_SYCN_HIDE,R.string.enter_sync_mode_hint);
	...
	private void setupListenerEvent(){
		...
		mImportLayout.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent intent = new Intent(SyncBrowserActivity.this,HostSyncActivity.class);
				intent.putExtra(Utils.SYNC_READ_HOST_KEY, true);
				intent.putExtra(KEY_RESELECTED, mIsReselect);
	...
	private void startSyncView(String path) {
		...
		Intent intent = new Intent(SyncBrowserActivity.this, HostSyncActivity.class);
		intent.putExtra(Utils.SYNC_READ_HOST_KEY, true);
		intent.putExtra(Utils.SYNC_HOST_NO_SELECT, true);
		intent.putExtra(Utils.SYNC_READ_PATH, path);
		startActivity(intent);
	}
