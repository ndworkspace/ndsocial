...
public abstract class ImageViewTouchBase extends ImageView implements
	...
	/**
	 * retain the transform Matrix and other context
	 * add by tangtaotao
	 * */
	public void setImageDrawableRetain(Drawable drawable) {
		super.setImageDrawable(drawable);
	}
	
	/**
	 * retain the scale and center point of the previous frame
	 * tangtaotao add
	 * */	
	public void setImageBitmapRetain(final Bitmap bitmap) {
		if (bitmap != null)
			setImageDrawableRetain(new FastBitmapDrawable(bitmap));
	}
